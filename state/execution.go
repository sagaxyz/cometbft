...
func (blockExec *BlockExecutor) ValidateBlock(state State, block *types.Block) error {
	blockExec.logger.Info("ValidateBlock::ValidateBlock", "state", state, "block", block)
...
func (blockExec *BlockExecutor) ApplyBlock(
	...
	blockExec.logger.Info("ValidateBlock::ApplyBlock", "state", state, "block", block)
...
func (blockExec *BlockExecutor) applyBlock(state State, blockID types.BlockID, block *types.Block) (State, error) {
	...
	blockExec.logger.Info("After FinalizeBlock", "abciResponse", abciResponse)
